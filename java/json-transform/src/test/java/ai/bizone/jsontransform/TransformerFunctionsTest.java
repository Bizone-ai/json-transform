...
import ai.bizone.jsontransform.functions.common.ArgType;
import ai.bizone.jsontransform.functions.common.ArgumentType;
import ai.bizone.jsontransform.functions.common.FunctionContext;
import ai.bizone.jsontransform.functions.common.FunctionDescription;
    ...
    private static class TransformerFunctionArgsTest extends TransformerFunction {
        public TransformerFunctionArgsTest() {
            super(FunctionDescription.of(
                Map.of("a", ArgumentType.of(ArgType.Any).position(0),
                       "b", ArgumentType.of(ArgType.Any).position(1),
                       "c", ArgumentType.of(ArgType.Any).position(2)
                )
            ));
        }
