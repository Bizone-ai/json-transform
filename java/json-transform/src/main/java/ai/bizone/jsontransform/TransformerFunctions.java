...
public class TransformerFunctions implements TransformerFunctionsAdapter {
    ...
    static {
        registerFunctions(
                ...
                Map.entry("cidrtest", new TransformerFunctionCidrTest()),
                Map.entry("coalesce", new TransformerFunctionCoalesce()),
                Map.entry("compress", new TransformerFunctionCompress()),
                ...
                Map.entry("decompress", new TransformerFunctionDecompress()),
                ...
                Map.entry("random", new TransformerFunctionRandom()),
     ...
     */
    public FunctionMatchResult<Object> matchObject(JsonAdapter<?,?,?> adapter, String path, Object definition, ParameterResolver resolver, JsonTransformerFunction transformer) {
        if (definition == null) {
            return null;
        }
    ...
    private InlineFunctionContext tryParseInlineFunction(JsonAdapter<?,?,?> adapter, String path, String value, ParameterResolver resolver,
