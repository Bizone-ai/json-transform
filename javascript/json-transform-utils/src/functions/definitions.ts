...
export default {
  ...
  xml: {
    ...
    arguments: [
      ...
      {
        name: "attr_prefix",
        description: "Prefix for properties to be used as XML attributes",
        type: "string",
        position: 2,
        default: "@",
      },
      {
        name: "cdata_prop_name",
        description: "A key for the text/CDATA section (when needed)",
        type: "string",
        position: 3,
        default: "#text",
      },
  ...
  xmlparse: {
    ...
    notes: "- Elements with text and attributes will be converted to objects with a `#text` field for the text",
    ...
    arguments: [
      ...
      {
        name: "attr_prefix",
        description: "Prefix for properties extracted from XML attributes",
        type: "string",
        position: 2,
        default: "@",
      },
