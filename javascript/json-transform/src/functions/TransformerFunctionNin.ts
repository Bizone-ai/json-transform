...
class TransformerFunctionNin extends TransformerFunction {
  constructor() {
    super({
  ...
  override async apply(context: FunctionContext): Promise<any> {
    ...
    return collection !== null && collection.stream().none(other => isEqual(value, other));
  }
}

export default TransformerFunctionNin;
